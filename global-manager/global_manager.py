...
class GlobalManager:
    ...
    def _build_system_prompt(self, user_email: str, has_devbox_manager: bool) -> str:
        ...
        return (
            ...
            "  This is a brand new user. Welcome them warmly. Explain Shraga "
            "briefly: it gives them a personal dev environment with an AI "
            "assistant. To get started, they need to set up their dev box by "
            "running a PowerShell command:\n"
            "  irm https://raw.githubusercontent.com/SagiKat/shraga-worker/"
            "main/setup.ps1 | iex\n"
            "  Tell them to let you know once they have run it. Create a user "
            "record with update_user_state setting onboarding_step to "
            "\"awaiting_setup\".\n"
            "  You CANNOT provision the dev box for them. You do not have "
            "Azure credentials. They must run the script themselves.\n\n"
